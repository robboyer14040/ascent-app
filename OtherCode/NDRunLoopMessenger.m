...
NSString		* kThreadDictionaryKey = @"NDRunLoopMessengerInstance";
...
- (void)messageInvocation:(NSInvocation *)anInvocation withResult:(BOOL)aResultFlag
{
    ...
    theMessage->invocation = anInvocation;        // will be released by handlePortMessage
...
{
	return [[NDRunLoopMessengerForwardingProxy alloc] _initWithTarget:aTarget withOwner:self withResult:NO];
}
...
{
	return [[NDRunLoopMessengerForwardingProxy alloc] _initWithTarget:aTarget withOwner:self withResult:aResultFlag];
}
