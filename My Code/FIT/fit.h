...
#include "fit_config.h"
   ...
   ///rcb typedef unsigned long uint32_t;
   ///rcb typedef signed long int32_t;
    typedef unsigned int uint32_t;  /// rcb to be compatible with apple
    typedef signed int int32_t;      /// rcb to be compatible with apple
