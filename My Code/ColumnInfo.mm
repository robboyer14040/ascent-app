...
static tColInfo sColInfo[] = 
{
	...
	{ "MaxSpd",          "Maximum Speed",				kCT_MaxSpeed,     "#0.0",     kMT_MaxSpeed,        50,    kUT_IsSpeed,			kDefaultField | kUseNumberFormatter },
    ...
    { "Suffer Score",    "Suffer Score",                kCT_SufferScore,  "",         kMT_SufferScore,     46,    kUT_IsJustANumber,    kUseNumberFormatter  },
	...
	{ "MaxPwr",          "Maximum Power",				kCT_MaxPower,	  "#,##0",    kMT_MaxPower,        46,     kUT_IsPower,			kDefaultField | kUseNumberFormatter },
	...
	{ "Equipment",       "Equipment",					kCT_Equipment,    "",         kMT_Equipment,       60,    kUT_IsText,			kDefaultField | kUseStringComparator  | kLeftAlignment},
	...
	{ "Notes",           "Notes",						kCT_Notes,        "",         kMT_Notes,           124,   kUT_IsText,			kDefaultField | kUseStringComparator  | kLeftAlignment },
...
/*4*/	{ "AvgSpd",         "Average Speed",					kSPLC_AvgSplitSpeed,			"#0.0",    kSPLM_AvgSplitSpeed,			50,    kUT_IsSpeed,		kUseNumberFormatter },
...
/*8*/	{ "AvgPce",         "Average Pace",						kSPLC_AvgPace,					"#0.00",    kSPLM_AvgPace,					50,    kUT_IsPace,		kDefaultField | kUsePaceFormatter },
...
/*12*/	{ "AvgHR",          "Average Heart Rate",				kSPLC_AvgHeartRate,				"##0",      kSPLM_AvgHeartRate,				46,    kUT_IsHeartRate,	kUseNumberFormatter },
...
/*16*/	{ "AvgCad",         "Average Cadence",					kSPLC_AvgCadence,				"##0",      kSPLM_AvgCadence,				46,    kUT_IsCadence,	kUseNumberFormatter },
...
/*20*/	{ "AvgPwr",         "Average Power",					kSPLC_AvgPower,					"#,##0",   kSPLM_AvgPower,					46,    kUT_IsPower,		kUseNumberFormatter },
...
/*24*/	{ "AvgGrd",         "Average Gradient",					kSPLC_AvgGradient,				"#0.0",     kSPLM_AvgGradient,				46,    kUT_IsGradient,	kUseNumberFormatter },
...
/*29*/	{ "Calories",       "Calories",							kSPLC_Calories,					"##0",      kSPLM_Calories,					54,    kUT_IsCalories,	kUseNumberFormatter },
...
/*31*/	{ "Climb",          "Climb",							kSPLC_Climb,					"#,##0",	kSPLM_Climb,					82,    kUT_IsClimb,		kDefaultField | kUseNumberFormatter },
...
/*33*/	{ "+VAM",			"Rate Of Climb (+VAM)",				kSPLC_RateOfClimb,				"#,##0",	kSPLM_RateOfClimb,			    82,    kUT_IsVAM,		kDefaultField | kUseNumberFormatter },
...
/*34*/	{ "-VAM",			"Rate Of Descent (-VAM)",			kSPLC_RateOfDescent,			"#,##0",	kSPLM_RateOfDescent,			82,    kUT_IsVAM,		kUseNumberFormatter },
